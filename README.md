...
- **Business Ops** — analyzes vendors, sourcing decisions, and supply chain strategy from a practical operations standpoint; supports uploading CSV/Excel files for direct data analysis
